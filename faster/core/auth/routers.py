...
# =============================================================================
#
# NOTE: Password management is now handled directly by Supabase Auth via the frontend.
# The following endpoints have been removed as they are no longer needed:
# - /password/change
# - /password/reset/initiate
# - /password/reset/confirm
#
# This approach follows Supabase best practices for client-side auth operations.
